  ...
  return (
    <div style={styles.container}>
      <section style={styles.section}>
        <h2 style={styles.h2}>Sem 7</h2> {/* Updated the h2 tag */}
        ...
        <div style={styles.gap}>
          <input
            ...
            id="s1"
            style={styles.input}
            placeholder="21XX71 - Professional Core Course - 3 Credits"
            value={scores.s1}
        ...
        <div style={styles.gap}>
          <input
            ...
            id="s2"
            style={styles.input}
            placeholder="21XX72X - Professional Elective II - 3 Credits"
            value={scores.s2}
            onChange={handleChange}
            min="0"
            max="100"
        ...
        <div style={styles.gap}>
          <input
            ...
            id="s3"
            style={styles.input}
            placeholder="21XX73X - Professional Elective III - 3 Credits"
            value={scores.s3}
            onChange={handleChange}
            min="0"
            max="100"
        ...
        <div style={styles.gap}>
          <input
            ...
            id="s4"
            style={styles.input}
            placeholder="21XX74X - Open Elective II - 3 Credits"
            value={scores.s4}
            onChange={handleChange}
            min="0"
            max="100"
        ...
        <div style={styles.gap}>
          <input
            ...
            id="s5"
            style={styles.input}
            placeholder="21XXP75 - Project Work - 10 Credits"
            value={scores.s5}
            onChange={handleChange}
            min="0"
            max="100"
        ...
        <div style={styles.gap}>
          <input
            ...
            id="s6"
            style={styles.input}
            placeholder="21XX76x - Ability Enhancement Course VI - 2 Credits"
            value={scores.s6}
            onChange={handleChange}
            min="0"
            max="100"
