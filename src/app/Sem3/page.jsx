  ...
  return (
    <div style={styles.container}>
      <section style={styles.section}>
        <h2 style={styles.h2}>Sem 3</h2> {/* Updated the h2 tag */}
